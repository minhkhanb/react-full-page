...
var FullPage = /*#__PURE__*/function (_React$Component) {
  ...
  function FullPage(props) {
    ...
    _this.onTouchStart = function (evt) {
      ...
      _this.xFrom = window.scrollY || window.pageYOffset || 0;
      console.log('xFrom: ', _this.xFrom);
    };
    ...
    _this.onTouchEnd = function (evt) {
      var touchEnd = evt.changedTouches[0].clientY;
      var touchSensitivity = _this.props.touchSensitivity; // if (!this._isScrollPending && !this._isScrolledAlready) {

      console.log('_touchStart: ', _this._touchStart);
      console.log('touchSensitivity: ', touchSensitivity);
      console.log('touchEnd: ', touchEnd);
      var scrollDiff = window.scrollY - _this.xFrom;
      console.log('scrollDiff: ', scrollDiff, window.innerHeight); // const scrollDiff = scrollTo - scrollFrom;

      console.log('aaaaaaaaaaaaa: ', touchEnd + _this._touchStart);
